...
CREATE TABLE `role`  (
  ...
  `name` varchar(24) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '角色名(英文）',
...
INSERT INTO `role` VALUES (2, 'general', '普通用户', NULL, NULL, NULL, NULL);
...
CREATE TABLE `user`  (
  ...
  `admin` int(11) NULL DEFAULT 1 COMMENT '角色类型\r\n1：普通\r\n2：管理员',
  `create_date` timestamp(0) NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '注册时间',
...
INSERT INTO `user` VALUES (3, '11', '11', '11', 1, '2019-11-25 14:49:17', NULL, 1, 0);
INSERT INTO `user` VALUES (5, '33', '33', '33', 1, NULL, NULL, 1, 0);
INSERT INTO `user` VALUES (6, '44', '44', '44', 1, NULL, NULL, 1, 0);
INSERT INTO `user` VALUES (7, '55', '55', '55', 1, NULL, NULL, 1, 0);
